<%@ Page Title="" Language="C#" MasterPageFile="~/Uploader.Master" AutoEventWireup="true" CodeBehind="UploadEditAtm.aspx.cs" Inherits="Mphasis_webapp.UploadEditAtm" %>
            ...
            <table style="width: 100%">
                ...
                <tr>
                    ...
                    <asp:FileUpload ID="fileuploadExcel" runat="server" />
                        &nbsp;&nbsp;
                    <asp:Button ID="btnSend" runat="server" style="cursor:pointer"  Text="IMPORT" OnClick="btnUpload_Click" Font-Names="Cambria, Cochin, Georgia, Times" BorderWidth="0px" BackColor="#6699ff" Height="20px" Width="100px" Font-Size="15px" ForeColor="White"  CausesValidation="False" EnableViewState="False" UseSubmitBehavior="False"  ClientIDMode="Static" OnClientClick="ShowModal()" />
        ...
        <div style="width: 100%">
            <table style="width: 100%; text-align: center; font-size: small">
                ...
                <tr>
                    ...
                    <td>
                        <div style="height: 500px; width:650px;overflow-x: scroll; overflow-y: scroll">
