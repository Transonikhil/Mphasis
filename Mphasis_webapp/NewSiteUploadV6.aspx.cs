                            ...
                            for (int rowNum = 2; rowNum <= 10000; rowNum++)
                            {
                                ...
                                select 1 as 'status'
                                    ...
                                    if (val == "OK")
                                    {
                                                            ...
                                                            if (datevalue < 31)
                                                            {
...

                                                                {
                                                                    ...
                                                                    if (done > 0)
                                                                    {
                                                                        ...
                                                                        mod_lblerror.Text = "Upload Succesful";
                                        ...
                                        else if (type.ToString().ToUpper().Trim() == "DEL")
                                        {
                                            ...
                                            string userMap = "update scheduler set status='DEL',serverstatus='DEL' where atmid='" + siteid + "' and userid='" + userid + "' and date='" + _month + "/" + _date1 + "/" + System.DateTime.Now.ToString("yyyy") +
                                                "'";// update users set datastatus='MOD' where userid='"+ userid +"'"; //"insert into scheduler (userid, siteid, date,status,serverstatus) values ('" + userid + "','" + siteid + "','" + _date + "','CRE','CRE')";
