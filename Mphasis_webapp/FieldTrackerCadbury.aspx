<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="FieldTrackerCadbury.aspx.cs" Inherits="Mphasis_webapp.FieldTrackerCadbury" %>
    ...
    <table class="style3">
        <tr>
            ...
            <td class="auto-style2">
                ...
                <asp:ImageButton ID="ImageButton2" runat="server" Height="114px" ImageUrl="~/Image/map.jpg" style="text-align: center; margin-left: 0px" Width="126px" PostBackURL="LocatorN.aspx" />
                <br />
                </strong></span> </td>
        </tr>
        <tr>
            <td class="style9">
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <strong>
                <a href="FieldTrackerCadbury.aspx?online=True">Online</a></strong></td>
            <td>
                <span class="style9"><strong>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <a href="FieldTrackerCadbury.aspx?Offline=True">Offline</a></strong></span>
            </td>
            <td>
                <span class="style9"><strong><a href="FieldTrackerCadbury.aspx?Battery=True">Battery Low / Down</a></strong></span></td>
            <td>
                <span class="style9"><strong>
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </strong>
