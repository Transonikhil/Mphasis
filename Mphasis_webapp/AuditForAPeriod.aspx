<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="AuditForAPeriod.aspx.cs" Inherits="Mphasis_webapp.AuditForAPeriod" %>
    ...
    <div style="font-size: x-large; font-family: Cambria, Cochin, Georgia, Times; font-variant: small-caps; width: 100%">
            ...
            <tr>
                ...
                <td style="padding-top: 0.5em;">
                    <asp:Button ID="btn_Update" Height="30px" Width="100px" Font-Size="18px" Font-Names="Cambria, Cochin, Georgia, Times;" runat="server" BorderWidth="0px" BackColor="#003366" ForeColor="White" Text="Search" OnClick="btn_Update_Click" />
                        <asp:ImageButton ID="ImageButton2" runat="server" Height="20px" Style="text-align: left"
                        ImageUrl="~/Image/EXCEL.ICO" Width="20px" OnClick="ImageButton2_Click" />
                </td>
            </tr>
        </table>
        &nbsp;&nbsp;&nbsp;
        ...
        <div align="center">
            <asp:GridView ID="GridView1" runat="server" OnPageIndexChanging="GridView1_PageIndexChanging"
                AllowPaging="true" PageSize="12" OnRowDataBound="GridView1_RowDataBound"
...
<%--                <Columns>
                    <asp:HyperLinkField DataTextField="" DataNavigateUrlFields="VID,ATM"
                        DataNavigateUrlFormatString="Report.aspx?auditid={0}&atmid={1}&dnld_excel=Y" Text="Excel"
                        HeaderText="Report" />
