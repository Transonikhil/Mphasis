<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="AddUsers.aspx.cs" Inherits="Mphasis_webapp.AddUsers" %>
               ...
               <hr />
                  <table>
                      ...
                      <tr>
                          ...
                          <td>
                              <asp:Button ID="btn_Update" Height="30px" Width="190px" Font-Size="18px" Font-Names="Cambria, Cochin, Georgia, Times;" runat="server" CommandName="Update" BorderWidth="0px" BackColor="#003366" ForeColor="White" Text="Submit" OnClick="btn_Update_Click" />
