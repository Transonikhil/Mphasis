<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DeleteUser.aspx.cs" Inherits="Mphasis_webapp.UploadFormat.DeleteUser" %>
    ...
    <form id="form1" runat="server">
        ...
        <div style="text-align: center">
            <table style="width: 100%">
                ...
                <tr>
                    <td>
                        <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl="~/UploadATMS.aspx">HOME</asp:HyperLink>
                    </td>
                </tr>
                <tr>
                    <td></td>
                ...
                <tr>
                    ...
                    <asp:Button ID="btnSend" runat="server" Text="Import" OnClick="btnUpload_Click" CssClass="Button" ClientIDMode="Static" OnClientClick="ShowModal()" />
                        ...
                        &nbsp;&nbsp;
                    <asp:LinkButton runat="server" ID="lnkformat" Text="User Delete Upload Excel Format" OnClick="lnkformat_Click"></asp:LinkButton>
                    </td>
