<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="UnAudited.aspx.cs" Inherits="Mphasis_webapp.UnAudited" EnableEventValidation="false" %>
    ...
    <div style="font-size: x-large; font-family: Cambria, Cochin, Georgia, Times; font-variant: small-caps">
        <table style="width: 1032px">
            ...
            <tr>
                ...
                <td>
                    <asp:DropDownList ID="DropDownList1" runat="server" Width="320px" Height="20px" DataSourceID="SqlDataSource1"
                    ...
                    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:SQLConnstr %>"
                        SelectCommand="select distinct u.userid from users u join usermap us on u.userid=us.userid join atms a on us.atmid=a.atmid where role like(case  when role= '%' then (select userid from users where role in('AO','DE')) else @role end) order by u.userid asc">
                        <SelectParameters>
                    ...
                    <ajaxToolkit:RoundedCornersExtender ID="RoundedCornersExtender2" runat="server"
                        Enabled="True" Radius="10" TargetControlID="DropDownList1" ClientIDMode="Static">
