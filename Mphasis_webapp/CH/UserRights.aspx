<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="UserRights.aspx.cs" Inherits="Mphasis_webapp.CH.UserRights" EnableEventValidation="false"%>
...
<asp:HyperLinkField DataNavigateUrlFields="User" DataNavigateUrlFormatString="MAPATMS.aspx?userid={0}" 
                 ...
                 <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
                     ...
                     SelectCommand="select a.userid as [User], count(atmid) as [ATM] from users a left outer join usermap  as b on a.userid=b.userid where a.ch like @rm and a.userid like '%' + @user +'%' group by a.userid order by a.userid">
                     <SelectParameters>
