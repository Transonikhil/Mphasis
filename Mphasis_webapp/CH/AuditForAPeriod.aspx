<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="AuditForAPeriod.aspx.cs" Inherits="Mphasis_webapp.CH.AuditForAPeriod" EnableEventValidation="false" %>
        ...
        <table width="100%">
            <tr>
                ...
                <td class="auto-style1">
                    ...
                    <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:SQLConnstr %>" SelectCommand="select distinct client from atms where CH like @ch">
                        <SelectParameters>
                            <asp:SessionParameter Name="ch" Type="String" SessionField="sess_username" />
                        </SelectParameters>

                    </asp:SqlDataSource>
                    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:SQLConnstr %>" SelectCommand="select distinct bankid from atms where CH like @ch">
                        <SelectParameters>
                            <asp:SessionParameter Name="ch" Type="String" SessionField="sess_username" />
                        </SelectParameters>
                    </asp:SqlDataSource>
