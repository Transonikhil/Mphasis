<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="User.aspx.cs" Inherits="Mphasis_webapp.CH.User" EnableEventValidation="false" %>
...
<%--<asp:HyperLinkField DataNavigateUrlFields="User" DataNavigateUrlFormatString="MAPATMS.aspx?userid={0}" 
                 ...
                 <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
                     ...
                     SelectCommand="select userid as [User],username,role,state,rcm,cm,rm,ch,emailid,mobile from users where ch=@username and status <> 'DEL' and userid like '%' + @user +'%' group by userid,username,role,state,rcm,cm,rm,ch,emailid,mobile order by userid">
                     <SelectParameters>
