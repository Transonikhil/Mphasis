<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="CallEntry.aspx.cs" Inherits="Mphasis_webapp.CH.CallEntry" EnableEventValidation="false" %>
            ...
            try {
                ...
                if (x == "CLOSED" || x == "RESOLVED" || x == "CLOSE") {
                    if (rem.trim() == "" || fol.trim() == "") {
                        //alert('Please enter followup remark and upload attachment.');
                        ...
                        <table id="tblremark" style="width: 100%; border: #000000 solid 1px" cellpadding="0"
                            ...
                            <tr>
                                ...
                                <td style="border-bottom: #000000 solid 1px;align:center">
                                    ...
                                    </asp:TextBox>&nbsp;<cc1:timeselector ID="txtvtime" Width="130px" 
                                        runat="server" AllowSecondEditing="true" SelectedTimeFormat="TwentyFour">
                                    </cc1:timeselector>
