<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="LocatorN_Poly_1.aspx.cs" Inherits="Mphasis_webapp.CH.LocatorN_Poly_1" EnableEventValidation="false" %>
    ...
    <div style="font-size: x-large; font-family: Cambria, Cochin, Georgia, Times; text-align: left;">
        <div>
            <table width="100%">
                ...
                <asp:SqlDataSource ID="SqlDataSource1" runat="server"
                    ConnectionString="<%$ ConnectionStrings:SQLConnstr %>"
                    SelectCommand="select '%' as userid,'ALL' as username union all SELECT [userid],[username] FROM [users] where userid<>'admin' and status <> 'DEL' and  CH like @rm ">
