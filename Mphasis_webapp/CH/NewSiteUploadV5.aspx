<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="NewSiteUploadV5.aspx.cs" Inherits="Mphasis_webapp.CH.NewSiteUploadV5" EnableEventValidation="false"%>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
            ...
            <tr>
                <td colspan="4" style="border-style: solid; border-width: thin; text-align: center">
                    ...
                    <asp:Button ID="btnSend" runat="server" Text="Import" OnClick="btnUpload_Click" CssClass="Button"
                        ClientIDMode="Static" OnClientClick="ShowModal()" />
                ...
                <td colspan="4">
                    <fieldset>
                        ...
                        <asp:GridView ID="GridView2" runat="server" Width="100%" PageSize="15" AutoGenerateColumns="False"
                            ...
                            <Columns>
                                <asp:BoundField DataField="USERID" HeaderText="USERID" />
                                <asp:BoundField DataField="ATMID" HeaderText="SITEID" />
                                <asp:BoundField DataField="DATE" HeaderText="DATE" />
    ...
    <div id="mod" runat="server" style="text-align: center;display:none;">
        <p style="color: #003366; font-variant: small-caps; font-size: x-large; font-weight: bolder;
            text-align: left">
            MODIFY/DELETE SCHEDULER</p>
        <table style="width: 100%">
            <tr>
                <td>
                </td>
            ...
            <tr>
                <td colspan="4" style="border-style: solid; border-width: thin; text-align: center">
                    ...
                    <asp:Button ID="mod_btnSend" runat="server" Text="Import" OnClick="mod_btnUpload_Click"
                        CssClass="Button" ClientIDMode="Static" OnClientClick="ShowModal()" />
