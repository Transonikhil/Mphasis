<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="IncidentMasterReport.aspx.cs" Inherits="Mphasis_webapp.CH.IncidentMasterReport" EnableEventValidation="false" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:SQLConnstr %>"
        SelectCommand="Select a.ATMID as [ATM ID],I.ddocketnumber as [TICKET NO],CONVERT(VARCHAR(10), I.OpenDate, 103) + ' '+ CONVERT(VARCHAR(5), I.OpenDate, 108) 
                                    ...
                                    a.project like @proj and a.State like @zone and faultcode like @fault and a.bankid like @bankid and a.CH like @city and
