<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="LocatorOne_1.aspx.cs" Inherits="Mphasis_webapp.CH.LocatorOne_1" EnableEventValidation="false" %>
         ...
         <asp:DropDownList ID="ddToTime" CssClass="btn btn-default dropdown-toggle" AppendDataBoundItems="true" runat="server">
             ...
             <asp:ListItem>23:59</asp:ListItem>
                ...
                <asp:SqlDataSource ID="SqlDataSource1" runat="server"
                    ...
                    SelectCommand="SELECT [userid],[username] FROM [users] where userid<>'admin' and  status <> 'DEL'  and  CH like @rm order by userid">
