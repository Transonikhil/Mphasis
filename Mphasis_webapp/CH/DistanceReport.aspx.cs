    ...
    public partial class DistanceReport : System.Web.UI.Page
    {
        ...
        public static ArrayList PopulateUser(string state)
        {
            ...
            string strQuery = " select distinct u.userid from users u " +
                              " join usermap us on u.userid=us.userid join atms a on us.atmid=a.atmid where role in ('AO','CM','DE','CH','RM') " +
        ...
        protected void btn_search_Click(object sender, EventArgs e)
        {
            ...
            if (txtuser.Text == "")
            {
                ...
                case when d.Siteid='NA' then d.address  else a.addressline1 end  AS LOCATION,a.state as STATE,case when d.Siteid='NA' then '-'  else a.bankid end AS [BANK NAME], 
