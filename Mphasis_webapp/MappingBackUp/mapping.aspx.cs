            ...
            foreach (GridViewRow gvrow in GridView1.Rows)
            {
                ...
                if (chk != null & chk.Checked)
                {
                    string b = @"SET TRANSACTION ISOLATION LEVEL SERIALIZABLE; BEGIN TRANSACTION;
                                ...
                                "') BEGIN UPDATE usermap set status='MOD',serverstatus='MOD' where userid='" + ddlto.SelectedValue.Trim() + "' and atmid='" + gvrow.Cells[2].Text.Trim() +
                    ...
                    if (obj.NonExecuteQuery(b) != 0)
                    {
                        ...
                        string c = "Update Users set datastatus='MOD' where userid='" + GridView1.DataKeys[gvrow.RowIndex].Value.ToString().Trim() + "'";
