...
namespace Mphasis_webapp
{
    ...
    public partial class CurrentAuditSuspectedByDist : System.Web.UI.Page
    {
        ...
        protected void GridView1_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                ...
                vid.Text = "VIEW";
                vid.NavigateUrl = "CurrentAudit.aspx?userid=" + e.Row.Cells[0].Text.Trim() + "&&vdate=" + e.Row.Cells[1].Text.Trim() + "&&dist=yes";
        ...
        protected void timer_Tick(object sender, EventArgs e)
        {
            ...
            {
                bind = @"Select userid as [USERID],COUNT(userid) as [COUNT],vdate as [VISIT DATE] from DR_CTP where distance like '%.%' 
                        and Convert(int,LEFT(distance, CHARINDEX('.', distance) - 1)) > 1000 and CONVERT(date,vdate) between '" + txtfromdate.Text +
