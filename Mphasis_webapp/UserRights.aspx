<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="UserRights.aspx.cs" Inherits="Mphasis_webapp.UserRights" EnableEventValidation="false" %>
...
<asp:HyperLinkField DataNavigateUrlFields="User" DataNavigateUrlFormatString="MAPATMS.aspx?userid={0}" 
                 ...
                 <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
                     ...
                     SelectCommand="select userid as [User] from users where userid like '%' + @user +'%' and status<>'DEL' order by userid">
                     <SelectParameters>
