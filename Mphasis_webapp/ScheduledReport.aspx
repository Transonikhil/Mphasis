<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ScheduledReport.aspx.cs" Inherits="Mphasis_webapp.ScheduledReport" %>
    ...
    <div align="center">
        ...
        <div align="center">
            <div style="width: 800px; overflow: auto; font-size: medium">
                <asp:GridView ID="GridView1" runat="server" CellPadding="4" ForeColor="#333333" Style="margin-top: 0px" Width="909px" BorderColor="#003366" BorderWidth="2px" EnableSortingAndPagingCallbacks="true" OnPageIndexChanging="GridView1_PageIndexChanging" AllowPaging="true" PageSize="20">
