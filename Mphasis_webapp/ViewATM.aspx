<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ViewATM.aspx.cs" Inherits="Mphasis_webapp.ViewATM" %>
                        ...
                        <tr>
                            ...
                            <td style="width: 30%" valign="bottom">
                                            ...
                                            <div class="pam login_error_box uiBoxRed">
                                                <div class="fsl fwb fcb">&nbsp;&nbsp;Please provide ATM ID &nbsp;</div>
                                            </div>
                                            </asp:Panel>
                                        </td>
                            <td>
