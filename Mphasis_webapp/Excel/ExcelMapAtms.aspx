<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ExcelMapAtms.aspx.cs" Inherits="Mphasis_webapp.Excel.ExcelMapAtms" %>
                        ...
                        <div style="height: 500px; width:400px;overflow-x: scroll; overflow-y: scroll">
                            ...
                            <table>
                                <tr id="countAtmId" runat="server">
                                    <td>
                                        <asp:Label runat="server" ID="lblnum"  Font-Size="15px" Font-Bold="True">Number Of Siteid mapped :</asp:Label>
                         ...
                         <div style="height: 500px;width:400px; overflow-x: scroll; overflow-y: scroll">
                            ...
                            <table>
                                <tr id="Tr1" runat="server">
                                    ...
                                    <td>
                                        <asp:Label runat="server" ID="Label1"  Font-Size="15px" Font-Bold="True">Number Of Siteid Not mapped :</asp:Label>
                        ...
                        <div style="height: 500px; width:400px;overflow-x: scroll; overflow-y: scroll">
                            ...
                            <table>
                                <tr id="Tr2" runat="server">
                                    <td>
                                        <asp:Label runat="server" ID="Label2"  Font-Size="15px" Font-Bold="True">Number Of Siteid Already Mapped:</asp:Label>
