<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DeleteATM.aspx.cs" Inherits="Mphasis_webapp.Excel.DeleteATM" %>
            ...
            <table style="width: 100%">
                ...
                <tr>
                    ...
                    <asp:Button ID="btnSend" runat="server" Text="Import" OnClick="btnUpload_Click" CssClass="Button" ClientIDMode="Static" OnClientClick="ShowModal()" />
                        ...
                        &nbsp;&nbsp;
                    <asp:LinkButton runat="server" ID="lnkformat" Text="Excel Format" OnClick="lnkformat_Click"></asp:LinkButton>
                    </td>
                        ...
                        <div style="height: 500px; width:400px;overflow-x: scroll; overflow-y: scroll">
                            ...
                            <table>
                                <tr id="countAtmId" runat="server">
                                    <td>
                                        <asp:Label runat="server" ID="lblnum"  Font-Size="15px" Font-Bold="True">Number Of ATM ID Deleted :</asp:Label>
                         ...
                         <div style="height: 500px;width:400px; overflow-x: scroll; overflow-y: scroll">
                            ...
                            <table>
                                <tr id="Tr1" runat="server">
                                    ...
                                    <td>
                                        <asp:Label runat="server" ID="Label1"  Font-Size="15px" Font-Bold="True">Number Of ATM ID Not Deleted :</asp:Label>
