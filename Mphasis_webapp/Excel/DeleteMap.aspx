<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DeleteMap.aspx.cs" Inherits="Mphasis_webapp.Excel.DeleteMap" %>
    ...
    <form id="form1" runat="server">
        ...
        <div style="text-align: center">
            <table style="width: 100%">
                ...
                <tr>
                    <td>
                        <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl="~/Excel/ExcelUploader.aspx">HOME</asp:HyperLink>
                    </td>
                </tr>
                <tr>
                    <td></td>
                ...
                <tr>
                    ...
                    <asp:Button ID="btnSend" runat="server" Text="Import" OnClick="btnUpload_Click" CssClass="Button" ClientIDMode="Static" OnClientClick="ShowModal()" />
                        ...
                        &nbsp;&nbsp;
                    <asp:LinkButton runat="server" ID="lnkformat" Text="Import Excel Format" OnClick="lnkformat_Click"></asp:LinkButton>
                    </td>
                        ...
                        <div style="height: 500px; width:400px;overflow-x: scroll; overflow-y: scroll">
                            ...
                            <table>
                                <tr id="countAtmId" runat="server">
                                    <td>
                                        <asp:Label runat="server" ID="lblnum"  Font-Size="15px" Font-Bold="True">Number Of Mapping Removed :</asp:Label>
                         ...
                         <div style="height: 500px;width:400px; overflow-x: scroll; overflow-y: scroll">
                            ...
                            <table>
                                <tr id="Tr1" runat="server">
                                    ...
                                    <td>
                                        <asp:Label runat="server" ID="Label1"  Font-Size="15px" Font-Bold="True">Number Of Mapping not Removed :</asp:Label>
                        ...
                        <div style="height: 500px; width:400px;overflow-x: scroll; overflow-y: scroll">
                            ...
                            <table>
                                <tr id="Tr2" runat="server">
                                    <td>
                                        <asp:Label runat="server" ID="Label2"  Font-Size="15px" Font-Bold="True">Mapping alraedy removed :</asp:Label>
                                        <asp:Label runat="server" ID="lblalradyadd" Font-Size="15px" Font-Bold="True"></asp:Label></td>
                                    <td>
                                        <asp:LinkButton ID="lnkalradyadd" runat="server" OnClick="lnkalradyadd_Click">Export</asp:LinkButton>
                                    </td>
                                </tr>
