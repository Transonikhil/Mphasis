<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ExcelUser.aspx.cs" Inherits="Mphasis_webapp.Excel.ExcelUser" %>
            ...
            <table style="width: 100%">
                ...
                <tr>
                    ...
                    <asp:Button ID="btnSend" runat="server" Text="Import" OnClick="btnUpload_Click" CssClass="Button" ClientIDMode="Static" OnClientClick="ShowModal()" />
                        ...
                        &nbsp;&nbsp;
                    <asp:LinkButton runat="server" ID="lnkformat" Text="Users Upload Excel Format" OnClick="lnkformat_Click"></asp:LinkButton>
                    </td>
