<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="LocatorN_Poly_1.aspx.cs" Inherits="Mphasis_webapp.LocatorN_Poly_1" %>
        ...
        <div>
            <table width="100%">
                ...
                <tr>
                    ...
                    SelectCommand="select '%' as userid,'ALL' as username  union all SELECT [userid],[username] FROM [users] where userid<>'admin' and status <> 'DEL'"></asp:SqlDataSource>
                <br />
                    </td>
