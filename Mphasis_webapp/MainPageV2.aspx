<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="MainPageV2.aspx.cs" Inherits="Mphasis_webapp.MainPageV2" %>
    ...
    <div style="font-size: large; width: 100%; padding-top: 1em;">
        ...
        <tr style="display: none">
            ...
            <td style="text-align: center">
                ...
                <tr id="trATMShop" runat="server" visible="false">
                    <td>
                        <asp:Label ID="lbl_ATMShop" runat="server"></asp:Label>
                    </td>
                    <td>
                        <asp:Label ID="Label74" runat="server"></asp:Label>
                    </td>
                    <td style="text-align: center; display: none">
                        <asp:ImageButton ImageAlign="AbsMiddle" AlternateText="No Image" ID="ImageButton15" runat="server"
                            Width="100px" Height="100px" Style="cursor: pointer" OnClientClick="return LoadDivchk(this.src);" />
                    </td>
                </tr>
                <tr id="tr51" runat="server" visible="false">
                    ...
                    <td>
                        <asp:Label ID="lbl_A51" runat="server"></asp:Label>
                    </td>
                    <td style="text-align: center; display: none">
                        <asp:ImageButton ImageAlign="AbsMiddle" AlternateText="No Image" ID="ImageButton10" runat="server"
                            Width="100px" Height="100px" Style="cursor: pointer" OnClientClick="return LoadDivchk(this.src);" />
                    </td>
                </tr>
                <tr id="tr52" runat="server" visible="false">
                    <td>
                        <asp:Label ID="lbl_52" runat="server"></asp:Label>
                    </td>
                    <td>
                        <asp:Label ID="lbl_A52" runat="server"></asp:Label>
                    </td>
                    <td style="text-align: center; display: none">
                        <asp:ImageButton ImageAlign="AbsMiddle" AlternateText="No Image" ID="ImageButton11" runat="server"
                            Width="100px" Height="100px" Style="cursor: pointer" OnClientClick="return LoadDivchk(this.src);" />
                    </td>
                </tr>
                <tr id="tr53" runat="server" visible="false">
                    <td>
                        <asp:Label ID="lbl_53" runat="server"></asp:Label>
                    </td>
                    <td>
                        <asp:Label ID="lbl_A53" runat="server"></asp:Label>
                    </td>
                    <td style="text-align: center; display: none">
                        <asp:ImageButton ImageAlign="AbsMiddle" AlternateText="No Image" ID="ImageButton14" runat="server"
                            Width="100px" Height="100px" Style="cursor: pointer" OnClientClick="return LoadDivchk(this.src);" />
                    </td>
                </tr>
