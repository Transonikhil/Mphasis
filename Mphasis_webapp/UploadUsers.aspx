<%@ Page Title="" Language="C#" MasterPageFile="~/Uploader.Master" AutoEventWireup="true" CodeBehind="UploadUsers.aspx.cs" Inherits="Mphasis_webapp.UploadUsers" %>
            ...
            <table style="width: 100%">
                ...
                <tr>
                    ...
                    <asp:FileUpload ID="fileuploadExcel" runat="server" />
                        &nbsp;&nbsp;
                    <asp:Button ID="btnSend" runat="server" Text="Import" OnClick="btnUpload_Click" style="cursor:pointer" Font-Names="Cambria, Cochin, Georgia, Times" BorderWidth="0px" BackColor="#6699ff" Height="20px" Width="100px" Font-Size="15px" ForeColor="White"  CausesValidation="False" EnableViewState="False" UseSubmitBehavior="False"  ClientIDMode="Static" OnClientClick="ShowModal()" />
                        <asp:Button ID="btn_Submit0" runat="server" Style="display: none" />
                        &nbsp;&nbsp;
                    <asp:LinkButton runat="server" ID="lnkformat" Text="USERS UPLOAD EXCEL FORMAT" ForeColor="#6699ff" OnClick="lnkformat_Click"></asp:LinkButton>
                    </td>
                ...
                <tr>
                    ...
                    <td>
                        <div style="height: 500px; width:400px;overflow-x: scroll; overflow-y: scroll">
                            ...
                            <table>
                                <tr id="countUsers" runat="server">



                                    <td>
                                        <asp:Label runat="server" ID="lblnum"  Font-Size="15px" Font-Bold="True">NUMBER OF USER UPLOADED :</asp:Label>
                            ...
                            <asp:GridView ID="GridView1" Width="100%" runat="server" CssClass="alignment" BackColor="White" BorderColor="White" BorderStyle="Ridge" BorderWidth="2px" CellPadding="3" GridLines="None" CellSpacing="1">
                                ...
                                <HeaderStyle BackColor="#666666" Font-Bold="True" ForeColor="#E7E7FF" />
                         ...
                         <div style="height: 500px;width:400px; overflow-x: scroll; overflow-y: scroll">
                            ...
                            <table>
                                <tr id="Tr1" runat="server">
                                    ...
                                    <td>
                                        <asp:Label runat="server" ID="Label1"  Font-Size="15px" Font-Bold="True">NUMBER OF USER NOT UPLOADED :</asp:Label>
                         ...
                         <div style="height: 500px;width:400px; overflow-x: scroll; overflow-y: scroll">
                            ...
                            <table>
                                <tr id="Tr2" runat="server">
                                    <td>
                                        <asp:Label runat="server" ID="Label3"  Font-Size="15px" Font-Bold="True">NUMBER OF USER ALREADY EXISTS :</asp:Label>
