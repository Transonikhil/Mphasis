...
{
    public partial class ChronicleIssues : System.Web.UI.Page
    {
            ...
            using (SqlConnection conn = new SqlConnection())
            {
                ...
                using (SqlCommand cmd = new SqlCommand())
                {
                    ...
                    cmd.CommandText = "select distinct atmid from atms where " +
                     "atmid like @SearchText + '%' and  a.bankid='TAMILNAD MERCANTILE BANK LIMITED' ";
                    ...
                    conn.Close();
                    cmd.CommandText = "select distinct siteid from atms where " +
                    "siteid like @SearchText1 + '%' and a.bankid='TAMILNAD MERCANTILE BANK LIMITED'";
                    ...
                    using (SqlDataReader sdr = cmd.ExecuteReader())
                    {
                        while (sdr.Read())
                        {
                            customers.Add(sdr["siteid"].ToString());
                        }
                    }
                    conn.Close();
                    return customers;
        ...
        protected void btn_search_Click(object sender, EventArgs e)
        {
            ...
            string sql = @"Select i.atmid as [ATMID],a.SiteID as [SITE ID],addressline1 as [ADDRESS],bankid as [BANK],DDocketNumber as [TICKET NUMBER],CONVERT(varchar(10),OpenDate,103) + ' ' + CONVERT(varchar(10),OpenDate,108) as [CALL OPEN DATE] " +
                 ...
                 "  and a.bankid='TAMILNAD MERCANTILE BANK LIMITED' and (i.atmid like '%" + txtAtm.Text + "' or a.Siteid like '%" + txtAtm.Text + "') " +
        ...
        protected void ImageButton1_Click(object sender, ImageClickEventArgs e)
        {
            ...
            GridView1.DataBind();
            Response.AddHeader("content-disposition", "attachment;filename=ChronicleIssueReport.xls");
