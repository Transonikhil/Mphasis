<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="IncidentMasterReport.aspx.cs" Inherits="Mphasis_webapp.bank.IncidentMasterReport" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
            ...
            <tr style="color: black">
                ...
                <td colspan="2">
                    ...
                    <asp:SqlDataSource ID="ZoneDataSource" runat="server" ConnectionString="<%$ ConnectionStrings:SQLConnstr %>"
                        SelectCommand="Select distinct [state] FROM [ATMs] where bankid='TAMILNAD MERCANTILE BANK LIMITED'">
                        <SelectParameters>
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:SQLConnstr %>"
        SelectCommand="Select a.ATMID as [ATM ID],I.ddocketnumber as [TICKET NO],CONVERT(VARCHAR(10), I.OpenDate, 105) + ' '+ CONVERT(VARCHAR(5), I.OpenDate, 108) 
                                    ...
                                    a.project like @proj and a.State like @zone and faultcode like @fault and a.bankid = 'TAMILNAD MERCANTILE BANK LIMITED' and a.RCM like @city and
