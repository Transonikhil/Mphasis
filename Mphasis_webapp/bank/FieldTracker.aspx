<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="FieldTracker.aspx.cs" Inherits="Mphasis_webapp.bank.FieldTracker" %>
    ...
    <table class="style3">
        <tr>
            ...
            <td class="auto-style2">
                ...
                <asp:ImageButton ID="ImageButton2" runat="server" Height="114px" ImageUrl="~/Image/map.jpg" style="text-align: center; margin-left: 0px" Width="126px" PostBackURL="LocatorOne.aspx?userid=ALL" />
                <br />
                </strong></span> </td>
        </tr>
        <tr>
