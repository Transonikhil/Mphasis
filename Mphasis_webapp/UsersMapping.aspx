...
<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="UsersMapping.aspx.cs" Inherits="Mphasis_webapp.UsersMapping" %>
            ...
            <tr>
                ...
                <td>
                    ...
                    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:SQLConnstr %>"
                        SelectCommand="select distinct u.userid from users u join usermap us on u.userid=us.userid join atms a on us.atmid=a.atmid where u.status <> 'DEL' and role like(case  when role= '%' then (select userid from users where role in('AO','DE')) else @role end) order by u.userid">
                        <SelectParameters>
