<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="SchedulerDashboard.aspx.cs" Inherits="Mphasis_webapp.SchedulerDashboard" EnableEventValidation="false" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div style="font-size: x-large; font-family: Cambria, Cochin, Georgia, Times; font-variant: small-caps; width: 100%">
                        ...
                        <tr>
                            <td>
                                <asp:Button ID="btn_search" Height="30px" Width="100px" Font-Size="18px" Font-Names="Cambria, Cochin, Georgia, Times;"
                                    runat="server" BorderWidth="0px" BackColor="#003366" ForeColor="White" Text="View"
        ...
        <div align="center" id="dwn" runat="server"><br />
            <asp:Chart ID="Chart3" runat="server" Width="853px" Palette="Bright" DataSourceID="SqlDataSource2">
                <Series>
                    <asp:Series Name="Series1" XValueMember="criteria" YValueMembers="count" IsValueShownAsLabel="True">
                    </asp:Series>
                </Series>
                <ChartAreas>
