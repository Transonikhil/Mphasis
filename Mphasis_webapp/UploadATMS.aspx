<%@ Page Title="" Language="C#" MasterPageFile="~/Uploader.Master" AutoEventWireup="true" CodeBehind="UploadATMS.aspx.cs" Inherits="Mphasis_webapp.UploadATMS" %>
            ...
            <table style="width: 100%">
                ...
                <tr>
                    ...
                    <asp:Button ID="btnSend" runat="server" Text="IMPORT" OnClick="btnUpload_Click" style="cursor:pointer" Font-Names="Cambria, Cochin, Georgia, Times" BorderWidth="0px" BackColor="#6699ff" Height="20px" Width="100px" Font-Size="15px" ForeColor="White"  CausesValidation="False" EnableViewState="False" UseSubmitBehavior="False"  ClientIDMode="Static" OnClientClick="ShowModal()" />
                        ...
                        &nbsp;&nbsp;
                    <asp:LinkButton runat="server" ID="lnkformat" Text="ATM ID UPLOAD EXCEL FORMAT" ForeColor="#6699ff" OnClick="lnkformat_Click"></asp:LinkButton>
                    </td>
                ...
                <tr>
                    ...
                    <td>
                        <div style="height: 500px; width:400px;overflow-x: scroll; overflow-y: scroll">
                            ...
                            <asp:GridView ID="GridView1" Width="100%" runat="server" CssClass="alignment" BackColor="White" BorderColor="White" BorderStyle="Solid" BorderWidth="2px" CellPadding="3" GridLines="None" CellSpacing="1">
                                <EmptyDataTemplate>
                                    NO ATM ID ADDED
                                </EmptyDataTemplate>
