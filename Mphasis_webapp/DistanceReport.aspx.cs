...
namespace Mphasis_webapp
{
    public partial class DistanceReport : System.Web.UI.Page
    {
        ...
        public static ArrayList PopulateUser(string state, string role)
        {
            ...
            string strQuery = " SELECT  distinct userid as userid,userid FROM [users] where role like '" + role + "'";
                    ...
                    using (SqlDataAdapter sda = new SqlDataAdapter())
                    {
                        ...
                        using (DataTable dt = new DataTable())
                        {
                            ...
                            using (ExcelPackage pck = new ExcelPackage())
                            {
                                ...
                                ws.Cells[1, 1, 100, 8].Style.Border.BorderAround(ExcelBorderStyle.Thin, System.Drawing.Color.Black);
                                ...
                                Response.Clear();
                                Response.AddHeader("content-disposition", "attachment;  filename=DistanceReport.xlsx");
