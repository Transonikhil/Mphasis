<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="DistanceReport.aspx.cs" Inherits="Mphasis_webapp.DistanceReport" EnableEventValidation="false" %>
        ...
        <table cellpadding="0" cellspacing="0" width="100%">
            <tr>
                <td style="width:50%" valign="top">
                    <div align="center" runat="server" id="div1" style="overflow: auto;font-size:13px"><br />
                ...
                <td style="width:45%;" valign="top">
                    ...
                    </ajaxToolkit:RoundedCornersExtender><br /><br />
                        <div>
