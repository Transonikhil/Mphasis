<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="OfficerwiseAudits.aspx.cs" Inherits="Mphasis_webapp.RM.OfficerwiseAudits" EnableEventValidation="false" %>
    ...
    <div style="font-size: x-large; font-family: Cambria, Cochin, Georgia, Times; font-variant: small-caps;">
            ...
            <tr>
                ...
                <td>
                    ...
                    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:SQLConnstr %>"
                        SelectCommand="select distinct userid from users where role in ('DE','AO') and RM like @rm  order by userid">
                        <SelectParameters>
        ...
        <div>
            <asp:GridView ID="GridView1" runat="server" PageSize="12" CellPadding="4" Font-Size="10pt"
                ForeColor="#333333" GridLines="None" AllowSorting="false" Width="1000px" Style="margin-top: 0px" OnRowDataBound="GridView1_RowDataBound"
                ...
                <Columns>
                    <asp:HyperLinkField DataTextField="" DataNavigateUrlFields="VID,ATM" DataNavigateUrlFormatString="Report.aspx?auditid={0}&&atmid={1}&dnld_excel=Y"
                    ...
                    <asp:HyperLinkField DataTextField="" DataNavigateUrlFields="VID" DataNavigateUrlFormatString="MainPage1.aspx?auditid={0}"
                        Text="View Report" HeaderText="Visit ID" />
                </Columns>
            </asp:GridView>
        </div>
        <hr />
