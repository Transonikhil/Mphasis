                            ...
                            for (int rowNum = 2; rowNum <= 10000; rowNum++)
                            {
                                try
                                {
                                    ...
                                    else
                                    {
                                        ...
                                        string[] c2 = { "userid" };
                                        string user = "Select userid from users where userid = '" + userid.ToString().Trim() + "' and RM like '" + Session["Sess_username"] + "'";
                                        ...
                                        string[] c3 = { "atmid" };
                                        string atm = "Select atmid from atms where atmid like '" + Atmid.ToString().Trim() + "' and RM like '" + Session["Sess_username"] + "'";
