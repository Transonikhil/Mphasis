<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ScheduledReport.aspx.cs" Inherits="Mphasis_webapp.RM.ScheduledReport" %>
    ...
    <div align="center">
        ...
        <div>
            <div style="width: 1000px; overflow: auto; font-size: medium">
                <asp:GridView ID="GridView1" runat="server" CellPadding="4" ForeColor="#333333" Style="margin-top: 0px" Width="909px" 
                    BorderColor="#003366" BorderWidth="2px" EnableSortingAndPagingCallbacks="true" OnPageIndexChanging="GridView1_PageIndexChanging" AllowPaging="true" PageSize="20">
