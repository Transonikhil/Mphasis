    ...
    public partial class OfficerwiseAudits : System.Web.UI.Page
    {
        ...
        protected void btn_search_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                c.atmid=a.atmid and Convert(date,vdate) between '" + txt_frmDate.Text +
                       "' AND '" + txt_toDate.Text + "'and RM like '" + Session["sess_username"] + "' and userid like '" + users +
                ...
                convert(varchar(10),convert(date,vdate),103) as [Audit Date],vtime as [Audit Time] from DR_CTP c, ATMs a where 
                c.atmid=a.atmid and Convert(date,vdate) between '" + txt_frmDate.Text +
                       "' AND '" + txt_toDate.Text + "'and RM like '" + Session["sess_username"] + "' and state in (" + txtuser.Text + ") and userid like '" + users +
                       "' order by Convert(date,vdate) desc,vtime desc";
                }
                /*------------------------------------------------------------------------------------------------*/
        ...
        protected void GridView1_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            ...
            //    hp.Text = "EXCEL";
            //    hp.NavigateUrl = "Report.aspx?auditid=" + e.Row.Cells[3].Text + "&&atmid=" + e.Row.Cells[4].Text + "&dnld_excel=Y";
