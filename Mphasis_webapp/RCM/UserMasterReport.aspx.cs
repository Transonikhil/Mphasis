...
namespace Mphasis_webapp.RCM
{
    public partial class UserMasterReport : System.Web.UI.Page
    {
        ...
        protected void btn_search_Click(object sender, EventArgs e)
        {
            ...
            b.enteredby as [USER],
            Convert(varchar(10),b.enteredon,103)+' '+ Convert(varchar(10), b.enteredon,108) as [ENTERED ON] from activity b join users a on b.enteredby = a.userid where b.enteredby like '" + users + "'and " + role + "  and convert(date,fromdate) between '" + txt_frmDate.Text + "' and '" + txt_toDate.Text + "' ";
            }
            else
            {
                sql = @"SELECT b.Vid AS [VISIT ID],b.reason as [REASON OF VISIT],b.remarks as [REMARKS],
                ...
                Convert(varchar(10),b.todate,103)+' '+ Convert(varchar(10),b.todate,108) as [END TIME],
                b.enteredby as [USER], 
                Convert(varchar(10),b.enteredon,103)+' '+ Convert(varchar(10), b.enteredon,108) as [ENTERED ON] from activity b join users a on b.enteredby = a.userid where b.enteredby like '" + users + "'and " + role + " and a.state in (" + txtuser.Text + ") and convert(date,fromdate) between '" + txt_frmDate.Text + "' and '" + txt_toDate.Text + "' ";
            }
