<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="mapping.aspx.cs" Inherits="Mphasis_webapp.RCM.mapping" %>
                ...
                <table style="width: 100%">
                    ...
                    <asp:DropDownList ID="ddlfrom" runat="server" AutoPostBack="True" DataSourceID="SqlDataSource3" DataTextField="userid" DataValueField="userid" OnSelectedIndexChanged="ddlfrom_SelectedIndexChanged"></asp:DropDownList>
                            <asp:SqlDataSource ID="SqlDataSource3" runat="server" ConnectionString="<%$ ConnectionStrings:SQLConnstr %>"
                                SelectCommand="SELECT [userid] FROM [users] WHERE role like @role and rcm like @rcm and (status<>'DEL' or datastatus<>'DEL')">
                                <SelectParameters>
                                    <asp:Parameter DefaultValue="AO" Name="role" Type="String" />
                                    <asp:SessionParameter Name="rcm" SessionField="Sess_username" DefaultValue="%" />
                                </SelectParameters>
                            </asp:SqlDataSource>
