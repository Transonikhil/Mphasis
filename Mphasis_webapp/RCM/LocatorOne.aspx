<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="LocatorOne.aspx.cs" Inherits="Mphasis_webapp.RCM.LocatorOne" %>
        ...
        <table width="100%" cellpadding="0" cellspacing="0" style="">
          ...
          <asp:TextBox ID="txt_frmDate" Height="20px" Width="138px" runat="server" ClientIDMode="Static"></asp:TextBox>
                ...
                <asp:SqlDataSource ID="SqlDataSource1" runat="server"
                    ...
                    SelectCommand="SELECT distinct [userid] FROM [users] where userid<>'admin' and role='AO' and RCM like @rcm order by userid">
