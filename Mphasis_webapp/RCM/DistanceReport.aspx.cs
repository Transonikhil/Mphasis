        ...
        public void drawmap(string users)
        {
            ...
            try
            {
                ...
                if (Request.QueryString["userid"] != "")
                {
                    ...
                    //Response.Write("Select case when d.siteid='NA' then vid else d.siteid end , lat,long from distance d left outer join atms a on a.siteid=d.siteid where userid='" + users + "'  and ldate=Convert(date,'" + txt_frmDate.Text + "') and lat <> '0' and long <> '0' order by ldate,ltime");
                }
                /////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
