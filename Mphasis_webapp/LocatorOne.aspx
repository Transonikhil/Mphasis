<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="LocatorOne.aspx.cs" Inherits="Mphasis_webapp.LocatorOne" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
       <table>
            <tr>
                <td style="color: #003366; font-family: Cambria, Cochin, Georgia, Times; font-size: x-large;
                    font-weight: bolder;">
                    <asp:Label ID="lblusername" runat="server"></asp:Label>
                </td>
                <td style="color: #003366; font-family: Cambria, Cochin, Georgia, Times; font-size: x-large;
                    font-weight: bolder; margin-left: 245px; float: right">
        ...
        <table width="100%" cellpadding="0" cellspacing="0" style="">
          ...
          <asp:TextBox ID="txt_frmDate" Height="20px" Width="138px" runat="server" ClientIDMode="Static"></asp:TextBox>
                ...
                <asp:SqlDataSource ID="SqlDataSource1" runat="server"
                    ...
                    SelectCommand="SELECT distinct [userid] FROM [users] where userid<>'admin' order by userid"></asp:SqlDataSource>
                <br />
