...
{
    public partial class CurrentAuditSuspectedByDate : System.Web.UI.Page
    {
        ...
        protected void GridView1_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                ...
                vid.Text = "VIEW";
                vid.NavigateUrl = "CurrentAudit.aspx?userid=" + e.Row.Cells[0].Text.Trim() + "&&vdate=" + e.Row.Cells[1].Text.Trim() + "&&dist=no";
